...
-- because halfway through the CSV, it randomly gains a column where the area code was
update wtr set "Area Code/Country" = "thing" where thing<>'';
update wtr set thing=NULL;

create index on wtr ("TX/Rx", "Azimuth");

create view data as select id, "TX/Rx" as tr, "Freq" as f, "Azimuth" as a, "Latitiude" as lat, "Longitude" as lon, "Product" as product, "Channel_Width" as cw, "Gain" as g from wtr;
